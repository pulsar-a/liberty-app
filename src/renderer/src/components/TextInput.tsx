...
export const TextInput: React.FC<TextInputProps> = ({
  ...
  return (
    <div className={clsx(className)}>
      ...
      <div className="mt-2">
        <div className="flex rounded-md bg-white/5 ring-1 ring-inset ring-indigo-700 dark:ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
          {prefix && (
