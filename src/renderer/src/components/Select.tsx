      ...
      {({ open }) => (
        <>
          ...
          <div className="relative mt-2">
            <Listbox.Button className="relative w-full cursor-default rounded-md bg-indigo-50 py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6 dark:bg-white/15 dark:text-white dark:ring-black">
